...
assemble/assemble.mjs                          # dependency-free Node kernel (sanitize / check-required / generate / migrate)
...
does the pure logic (`sanitize`, `checkRequired`, `generate`) and is unit-tested
without git/network/fs.
